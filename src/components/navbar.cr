class Navbar < BaseComponent
  def render
    para style: "margin-left: 0px;" do
      a href: "/", class: "allcaps" do
        raw <<-'HEREDOC'
<svg height="50" viewBox="0 0 207.90188 207.90188" width="50" xmlns="http://www.w3.org/2000/svg">
...
HEREDOC
    ...
    #       raw <<-'HEREDOC'
    # <canvas height="130" id="logo-canvas" style="cursor:move" width="130"></canvas>
